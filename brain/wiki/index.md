...
|------|-------------|------|
| project-overview | What word-guess is, core value, platform, monetization, game modes | project, mvp |
...
| daily-seed | Deterministic daily puzzle generation from date + private seed | daily-puzzle, seed, offline |
