...
export const lightColors = {
  ...
  keyHint: '#4FC3F7',        // light blue — letter-hint ghost tile border
  keyHintDim: '#81D4FA',     // soft fill for letter-hint ghost tile
  keyHintText: '#0D47A1',    // dark blue — text on hint ghost tile
...
export const darkColors = {
  ...
  keyHint: '#42A5F5',        // light blue — letter-hint ghost tile border
  keyHintDim: '#29B6F6',     // soft fill for letter-hint ghost tile
  keyHintText: '#FFFFFF',    // white — text on hint ghost tile (dark theme)
