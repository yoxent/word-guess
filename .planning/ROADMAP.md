...
**Plans:** 6 plans (06-01, 06-02, 06-03, 06-04, 06-05, 06-06)
**Plan list:**
...
4. **06-04** (Wave 3) — UI Polish: Home stagger entrance + HowToPlay modal, SettingsRow ThemeSelectorRow + toggle cases, centralized BackHandler in Navigation.tsx, NavigationContainer theme injection, StatusBar theme switching, remove 500ms setTimeout
5. **06-05** (Wave 3) — Theme Migration: colors-to-useColors migration across ~17 component/screen/app files
6. **06-06** (Wave 3) — Compliance + Build Readiness: docs/privacy.md, performance markers (__DEV__-guarded), EAS build checklist + offline verification docs
...
| Phase 6: Pre-Launch & Polish | 0/6 | 📋 Planned | 2026-07-09 |
